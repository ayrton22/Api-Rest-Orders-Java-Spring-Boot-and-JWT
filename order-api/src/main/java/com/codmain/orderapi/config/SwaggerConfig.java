...
public class SwaggerConfig {
    ...
    public Docket apiDocket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select().apis(RequestHandlerSelectors.basePackage("com.codmain.orderapi.controllers"))
                .paths(PathSelectors.any()).build().apiInfo(getApiInfo());
    }

    private ApiInfo getApiInfo() {
        return new ApiInfo("Order Service API", "Order Service API Description", "1.0", "http://codmind.com/terms",
                new Contact("AyrApi", "https://codmind.com", "themasterayrx@hotmail.com"), "LICENSE", "LICENSE URL",
